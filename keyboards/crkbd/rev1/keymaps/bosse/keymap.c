...
#include "oled.c"
 ...
 [_QWERTY] = LAYOUT_split_3x6_3(
    LT(_NAV,KC_TAB), KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, QK_GESC, 
    KC_MEH, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, 
    KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_ENT, 
    KC_LGUI, KC_LSFT, LT(_SYM,KC_SPC), LT(_NUM,KC_BSPC), KC_RSFT, KC_LALT
    ),
...
[_NUM] = LAYOUT_split_3x6_3(
    ...
    KC_LGUI, KC_LSFT, LT(_SYM,KC_SPC), KC_TRNS, KC_RSFT, KC_LALT
    ),
...
[_GAME] = LAYOUT_split_3x6_3(
    ...
    KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_ENT, 
    KC_LALT, KC_LSFT, KC_SPC, KC_BSPC, KC_RSFT, MO(_SYM)
    ),
