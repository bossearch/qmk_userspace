...
[_QWERTY] = LAYOUT_split_3x6_3(
    ...
    KC_LGUI, KC_LSFT, LT(_SYM,KC_SPC), LT(_NUM,KC_BSPC), KC_ESC, KC_LALT
    ),
...
[_SYM] = LAYOUT_split_3x6_3(
    ...
    KC_LGUI, KC_LSFT, KC_TRNS, LT(_NUM,KC_BSPC), KC_ESC, KC_LALT
    ),
...
[_NUM] = LAYOUT_split_3x6_3(
    ...
    KC_LGUI, KC_LSFT, LT(_SYM,KC_SPC), KC_TRNS, KC_ESC, KC_LALT
    ),
...
[_NAV] = LAYOUT_split_3x6_3(
    ...
    KC_LGUI, KC_LSFT, KC_BTN1, KC_BTN2, KC_ESC, KC_LALT
    ),
