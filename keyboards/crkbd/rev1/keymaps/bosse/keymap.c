...
[_QWERTY] = LAYOUT_split_3x6_3(
    ...
    KC_LCTL, ALT_ESC, SYM_SPC, NUM_BSPC, OSM_LSFT, KC_RCTL
    ),
...
[_SYM] = LAYOUT_split_3x6_3(
    ...
    KC_LGUI, MCR0, MCR1, MCR2, KC_LCBR, KC_LT, KC_GT, KC_RCBR, KC_COMM, KC_DOT, KC_QUES, KC_ENT,
    KC_LCTL, ALT_ESC, KC_TRNS, TMUX, KC_LSFT, KC_RCTL
    ),

[_NUM] = LAYOUT_split_3x6_3(
    KC_TAB, KC_P1, KC_P2, KC_P3, KC_P4, KC_P5, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_MPLY, WWW,
    KC_MEH, KC_P0, KC_P9, KC_P8, KC_P7, KC_P6, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_MUTE, KC_WFWD,
    KC_LGUI, KC_UNDO, KC_CUT, KC_COPY, KC_PSTE, CADEL, AF4, KC_BRID, KC_BRIU, TTY1, TTY2, KC_WBAK,
    KC_LCTL, ALT_ESC, KC_TRNS, KC_TRNS, KC_LSFT, KC_RCTL
    ),

[_NAV] = LAYOUT_split_3x6_3(
    KC_TRNS, KC_BTN1, KC_BTN3, KC_BTN2, QK_BOOT, TG_GAME, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, KC_HOME, KC_INS,
    KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_END, KC_DEL,
    KC_F12, KC_F11, KC_F10, KC_F8, KC_F7, KC_F12, KC_NUM, KC_PGDN, KC_PGUP, KC_SCRL, KC_PSCR, KC_ENT,
