...
[_NUM] = LAYOUT_split_3x6_3(
    KC_TAB, KC_1, KC_2, KC_3, KC_4, KC_5, KC_MRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_MLY, WWW,
    KC_MEH, KC_0, KC_9, KC_8, KC_7, KC_6, KC_LEFT, KC_DOWN, KC_U, KC_RGHT, KC_MUTE, KC_WFWD,
    KC_HYPR, KC_UNDO, KC_CUT, KC_COPY, KC_PSTE, CADEL, AF4, KC_BRID, KC_BRIU, TTY1, TTY2, KC_WBAK,
